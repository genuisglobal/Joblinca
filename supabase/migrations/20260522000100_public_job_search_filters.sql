-- Extend the public jobs marketplace search helpers with posted-date and
-- salary-range filters, and enforce newest-first ordering for listings.
...
COMMENT ON FUNCTION public.search_public_jobs(
  ...
  'Returns publicly listable jobs for the /jobs marketplace with newest-first ordering and extended filters.';
...
COMMENT ON FUNCTION public.search_public_job_counts(
  ...
  'Returns exact browse-tab counts and filtered totals for the /jobs marketplace with posted-date and salary filters.';

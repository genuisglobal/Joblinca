...
export default function JobsError({
  ...
  useEffect(() => {
    Sentry.captureException(error, { tags: { boundary: 'jobs' } });
    console.error(error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">Jobs Error</h1>
        <p className="text-gray-400 mb-6">
          Something went wrong while loading jobs. Please try again or browse
          all jobs.
        </p>

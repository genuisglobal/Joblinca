...
import { markRegistrationLeadOptedOut } from '@/lib/field-registration/service';
...
export async function POST(
  ...
  try {
    ...
    const lead = await markRegistrationLeadOptedOut(serviceClient, {
    ...
    const message =
      error instanceof Error ? error.message : 'Failed to update registration lead';
    const status =

...
export default function ResumePage() {
  ...
  /**
   * Handles input changes for the resume form.
   */
  ...
  /**
   * Calls the optimisation API to improve the resume.
   */
  ...
  /**
   * Saves the resume to Supabase via the save API.
   */
  ...
  /**
   * Generates a PDF for the resume (daily limit enforced by server).
   */
  ...
  return (
    <main className="max-w-3xl mx-auto p-6 text-gray-100">
      ...
      <div className="mb-6">
        ...
        {loading && <p className="text-sm text-gray-400 mt-2">Processing...</p>}
      </div>

      {/* Improved contrast card + inputs for dark theme */}
      <form
        onSubmit={handleSave}
